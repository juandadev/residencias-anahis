      ...
      <Page style={styles.page}>
        ...
        {data.map((item, index) => (
          <View key={`pdf-row-${index}`} style={styles.table_row}>
            ...
            <View style={styles.table_col_25}>
              <Text style={styles.cell_text}>{item.name_client}</Text>
            </View>
            <View style={styles.table_col_25}>
              <Text style={styles.cell_text}>{item.address_client}</Text>
            </View>
            <View style={styles.table_col_25}>
              <Text style={styles.cell_text}>{item.phone_client}</Text>
            </View>
            <View style={styles.table_col_25}>
              <Text style={styles.cell_text_email}>{item.email_client}</Text>
            </View>
          </View>
        ))}
