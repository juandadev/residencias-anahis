        ...
        {data.map((item, index) => (
          <View key={`pdf-row-${index}`} style={styles.table_row}>
            ...
            <View style={styles.table_col_18}>
              <Text style={styles.cell_text}>{item.name_vendor}</Text>
            </View>
            <View style={styles.table_col_18}>
              <Text style={styles.cell_text}>{item.social_vendor}</Text>
            </View>
            <View style={styles.table_col_18}>
              <Text style={styles.cell_text}>{item.phone_vendor}</Text>
            </View>
            <View style={styles.table_col_18}>
              <Text style={styles.cell_text}>{item.address_vendor}</Text>
            </View>
            <View style={styles.table_col_18}>
              <Text style={styles.cell_text}>{item.bank_vendor}</Text>
            </View>
          </View>
        ))}
